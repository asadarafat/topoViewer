...
Use [Attention TypeScript API](../reference/attention-typescript-api.md) when the host application owns attention indexing, scoring, aggregates, cached presentation state, or custom React integration.

## Exact Reference

Use [Attention Reference](../reference/attention-reference.md) for schema-backed object families, focus modes, click behavior, aggregate summary fields, and validation commands.
