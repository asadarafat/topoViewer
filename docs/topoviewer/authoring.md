...
Use [Topology Model](topology-model.md) for object-by-object YAML details covering layers, nodes, links, paths, regions, toggles, validation, shapes, callouts, and pins. Use [Object Attribute Reference](object-reference.md) when you need every schema attribute, accepted value, default, and validation note.
...
- [Stylesheet Reference](stylesheet-reference.md): inspect every style key, accepted value, and default.
