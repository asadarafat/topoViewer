...
Use this page when you need the exact attention contract. Use [Topology Attention](attention.md) for workflow and examples, and [Attention TypeScript API](attention-typescript-api.md) when host code owns indexing, focus, scoring, or presentation.
...
|---|---|---|
| Attention root | `interactive`, `clickMode`, `query`, `aggregate`, `links` | [Object Attribute Reference](object-reference.md#attention-root) |
| Focus query | `ids`, `labels`, `data`, `pathIds`, `regionIds`, `selectors`, `dependency`, `changes`, `mode` | [Object Attribute Reference](object-reference.md#attention-focus-query) |
| Dependency query | `from`, `direction`, `depth` | [Object Attribute Reference](object-reference.md#attention-dependency-query) |
| Change query | `since`, `timestampFields`, `revision`, `revisionFields` | [Object Attribute Reference](object-reference.md#attention-change-query) |
| Aggregate | `groups`, `expandedGroupIds`, `expandOnClick`, `viewport` | [Object Attribute Reference](object-reference.md#attention-aggregate) |
| Aggregate group | `id`, `by`, `regionId`, `parentId`, `key`, `value`, `label` | [Object Attribute Reference](object-reference.md#attention-aggregate-group) |
| Link grouping | `enabled`, `threshold`, `by`, `expandOnClick`, `viewport` | [Object Attribute Reference](object-reference.md#attention-link-grouping) |
