...
| --- | --- | --- |
| Public Entry Point Clarity | First screen explains the product; first screen is not an integration inventory; stable path is separated from roadmap | 2.1-2.8, 3.1-3.8, 4.1-4.6, 5.1-5.7, 18.1, 25.2-25.5 |
...
| Demo Gallery For Adoption | User wants visually compelling examples | 5.1-5.7, 17.1-17.11, 24.3, 25.10-25.11 |
...
| Cross-Surface Early-Adopter Ergonomics | User starts from YAML; integration page gives exact expectations; Grafana user brings own bundle | 2.1-2.8, 3.1-3.8, 4.1-4.6, 6.9-6.17, 8.1-8.22, 10.1-10.12, 18.1-18.4, 25.4-25.6, 25.10-25.11 |
