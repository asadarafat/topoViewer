...
- [ ] 2.1 Review the roadmap wording against `specs/netbox-integration-roadmap/spec.md`
- [ ] 2.2 Ensure `publish-visual-product-story` consumes the NetBox wording without duplicating the full spec
