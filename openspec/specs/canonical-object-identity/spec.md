# canonical-object-identity Specification

## Purpose
Define canonical editable object IDs, optional display aliases, deterministic
style ownership and precedence, atomic bundle-wide semantic rename, and
loss-aware legacy migration.
