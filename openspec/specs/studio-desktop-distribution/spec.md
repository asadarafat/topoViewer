# studio-desktop-distribution Specification

## Purpose
Define the Wails Desktop Studio host, confined native project lifecycle, and
platform-specific distribution and security gates while preserving the shared
Browser Studio authoring model.
## Requirements
