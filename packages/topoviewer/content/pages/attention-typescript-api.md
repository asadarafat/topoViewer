...
Use this page when a host application needs to build search, focus, scoring, aggregate, or custom presentation state with the TopoViewer attention engine. For YAML authoring, start with [Topology Attention](attention.md).
