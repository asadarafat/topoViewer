...
| Author with feedback | Use Browser Studio or build Desktop Studio for visual authoring, YAML assistance, validation, recovery, and export. |
...
- Browser Studio is the Beta Preview authoring and validation surface.
- Desktop Studio is the Experimental native directory-project distribution of
