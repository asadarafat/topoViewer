...
Use this page when you need object-by-object topology authoring details. Use [TopoViewer Authoring Model](authoring.md) for the higher-level authoring workflow, and [Object Attribute Reference](object-reference.md) for the generated schema-backed attribute contract.
