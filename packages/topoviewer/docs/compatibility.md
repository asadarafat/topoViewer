# Compatibility And API Ownership
...
- [TypeScript API](api-reference.md): supported, advanced, and experimental exports.
- [YAML schemas](schemas.md): published schema files and validation behavior.
- [Release checklist](release.md): manual publish and package artifact gates.
- [Production hardening](production.md): CI lanes, generated artifact contract, and failure triage.
