...
- [MkDocs](render-in-mkdocs.md): compare the supported plugin workflow with the Zensical adapter.
- [Examples](../../examples.md): review the curated examples that sync into both documentation surfaces.
- [Debug rendering](debug-rendering.md): investigate geometry or theme differences across docs surfaces.
