...
const edgeDefinitions = [
  ...
  def(['link', 'path'], 'sourceArrowLabel', 'Source arrow label', 'text', 'Port or endpoint label rendered near the source arrow/endpoint using the React Flow edge label layer.'),
  def(['link', 'path'], 'targetArrowLabel', 'Target arrow label', 'text', 'Port or endpoint label rendered near the target arrow/endpoint using the React Flow edge label layer.'),
  def(['link', 'path'], 'arrowLabelColor', 'Arrow label color', 'color', 'Shared source/target arrow label text color.', derived('lineColor', 'Falls back to the rendered edge line color.')),
  def(['link', 'path'], 'sourceArrowLabelColor', 'Source arrow label color', 'color', 'Source arrow label text color.', derived('arrowLabelColor', 'Falls back to arrowLabelColor, then lineColor.')),
  def(['link', 'path'], 'targetArrowLabelColor', 'Target arrow label color', 'color', 'Target arrow label text color.', derived('arrowLabelColor', 'Falls back to arrowLabelColor, then lineColor.')),
  def(['link', 'path'], 'sourceArrowLabelFontSize', 'Source arrow label font size', 'integer', 'Source arrow label font size.'),
  def(['link', 'path'], 'targetArrowLabelFontSize', 'Target arrow label font size', 'integer', 'Target arrow label font size.'),
  def(['link', 'path'], 'sourceArrowLabelFontWeight', 'Source arrow label font weight', 'text', 'Source arrow label font weight.', derived('sourceLabelFontWeight or labelFontWeight', 'Falls back to sourceLabelFontWeight, then labelFontWeight.')),
  def(['link', 'path'], 'targetArrowLabelFontWeight', 'Target arrow label font weight', 'text', 'Target arrow label font weight.', derived('targetLabelFontWeight or labelFontWeight', 'Falls back to targetLabelFontWeight, then labelFontWeight.')),
  def(['link', 'path'], 'sourceArrowLabelZIndex', 'Source arrow label z index', 'integer', 'Source arrow label draw order.', derived('sourceLabelZIndex or labelZIndex', 'Falls back to sourceLabelZIndex, then labelZIndex.')),
  def(['link', 'path'], 'targetArrowLabelZIndex', 'Target arrow label z index', 'integer', 'Target arrow label draw order.', derived('targetLabelZIndex or labelZIndex', 'Falls back to targetLabelZIndex, then labelZIndex.')),
  def(['link', 'path'], 'sourceArrowLabelXOffset', 'Source arrow label X offset', 'integer', 'Pixel X offset applied after the source arrow label auto-position.'),
  def(['link', 'path'], 'sourceArrowLabelYOffset', 'Source arrow label Y offset', 'integer', 'Pixel Y offset applied after the source arrow label auto-position.'),
  def(['link', 'path'], 'targetArrowLabelXOffset', 'Target arrow label X offset', 'integer', 'Pixel X offset applied after the target arrow label auto-position.'),
  def(['link', 'path'], 'targetArrowLabelYOffset', 'Target arrow label Y offset', 'integer', 'Pixel Y offset applied after the target arrow label auto-position.'),
