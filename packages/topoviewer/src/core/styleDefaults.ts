...
const textDefinitions = [
  ...
  def(['text'], 'width', 'Width', 'integer', 'Optional fixed text-box width; unset text auto-fits its content.', derived('content', 'Auto-fits content until a width or object size is set.')),
  def(['text'], 'height', 'Height', 'integer', 'Optional fixed text-box height; unset text auto-fits its content.', derived('content', 'Auto-fits content until a height or object size is set.')),
