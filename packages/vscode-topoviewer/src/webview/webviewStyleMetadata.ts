...
export const styleOptionsByKind: Record<TopoObjectSelection['kind'], Array<{ key: string; label: string }>> = {
  node: [
    ...
    { key: 'width', label: 'Body width' },
    { key: 'height', label: 'Body height' },
    ...
    { key: 'icon', label: 'Icon' },
    { key: 'iconSize', label: 'Inner icon size' },
    { key: 'iconWidth', label: 'Inner icon width' },
    { key: 'iconHeight', label: 'Inner icon height' },
    ...
    { key: 'labelZIndex', label: 'Label z index' },
  ...
  link: [
    ...
    { key: 'sourceLabelZIndex', label: 'Source label z index' },
    ...
    { key: 'targetLabelZIndex', label: 'Target label z index' },
