import type { StudioDiagnostic, StudioDocumentKind, StudioSessionSnapshot, StudioSourceDocument } from '../contracts/project';
...
export interface StudioDocumentSession {
  ...
  setValues(document: StudioDocumentKind, edits: Array<{ path: StudioYamlPath; value: unknown }>): StudioSessionUpdateResult;
  ...
  upsertValue(document: StudioDocumentKind, path: StudioYamlPath, value: unknown, scopePath: StudioYamlPath): StudioSessionUpdateResult;
}
