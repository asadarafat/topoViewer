...
export function createStudioExportSnapshot(
  project: StudioProject,
  sourceRevision: string
): StudioExportSnapshot {
  return deepFreeze({ project: structuredClone(project), sourceRevision }) as StudioExportSnapshot;
}

export async function runStudioExporter(
  exporter: StudioExporter,
