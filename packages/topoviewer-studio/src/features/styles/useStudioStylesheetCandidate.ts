...
import { createStylesheetCandidateController, defaultStructuredCandidateDelayMs, type StudioDocumentSession } from '../../session';
import { stylesheetCandidateInitialization } from './stylesheetCandidateActions';

export function useStudioStylesheetCandidate(session: StudioDocumentSession, recovery: StudioRecoverySnapshot['stylesheetCandidate']) {
